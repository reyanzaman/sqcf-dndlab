            ...
            <div className="mt-32 lg:mx-32 mx-0 lg:px-0 lg:py-8 p-8">
                ...
                <div className="hidden lg:block">
                  <h1 className="text-sm lg:mb-2 mb-1 lg:mt-0 mt-6 custom-font text-right">
                    <span className="text-amber-200">
                      {
                        writings.filter(
                          (writing) => writing.type === "Writings on QC"
                        ).length
                      }
                    </span>{" "}
                    Writings on QC |{" "}
              ...
              {searchQuery === "" ? (
                <div className="flex lg:flex-row flex-col justify-between anim-appear-7">
                  ...
                  <div className="mt-4">
                    <h1 className="text-3xl lg:text-right text-center">
                        ...
                        .map((art, index) => (
                          <div className="" key={index}>
                            <a
                              ...
                              Written By ${art.author_Bangla} | Published By ${art.publisher_Bangla}
                              <br><div style='color: #fde68a;'>${art.tags.join(
                                ", "
                              )} | ${art.tags_Bangla.join(", ")}</div></div>`}
                            >
                            ...
                            {art.title}
                              ...
                              <h1 className="text-center bangla-font text-base px-1 whitespace-nowrap text-ellipsis overflow-hidden">
                                {art.title_Bangla} | {art.date_Bangla}
                              </h1>
                              <h1 className="text-center text-xs px-1">
                        ...
                        .map((art, index) => (
                          <div className="" key={index}>
                            <a
                              ...
                              ${art.width} cm X ${art.height} cm | For ${art.for_whom}
                              <br><div style='color: #fde68a;'>${art.tags.join(
                                ", "
                              )} | ${art.tags_Bangla.join(", ")}</div></div>`}
                            >
                            ...
                            {art.title}
                              ...
                              <h1 className="text-center bangla-font text-base px-1 whitespace-nowrap text-ellipsis overflow-hidden">
                                {art.title_Bangla} | {art.year_Bangla}
                              </h1>
                        ...
                        .map((art, index) => (
                          <div className="" key={index}>
                            <a
                              ...
                              data-caption={`<div style='text-align: center;'>${
                                art.title_Bangla
                              } ${art.year_Bangla ? `| ${art.year_Bangla}` : ""}<br>
                              Published By ${art.publisher_Bangla}
                              <br><div style='color: #fde68a;'>${art.tags.join(
                                ", "
                              )} | ${art.tags_Bangla.join(", ")}</div></div>`}
                            ...
                            {art.title}
                              ...
                              <h1 className="text-center bangla-font text-base px-1 whitespace-nowrap text-ellipsis overflow-hidden">
                                {art.title_Bangla} {art.year_Bangla ? `| ${art.year_Bangla}` : ""}
                              </h1>
                              <h1 className="text-center text-xs px-1">
                              ...
                              <div className="relative group cursor-pointer">
                                {art.imageUrl ? (
                                  ...
                                  <div className="w-full lg:h-[20vw] h-[35vw] flex items-center justify-center border-4 border-black mb-2 bg-gray-100 transition-all duration-500 ease-in-out group-hover:brightness-[0.2] group-hover:border-8 group-hover:text-gray-100 text-black">
                                    <span className="lg:text-4xl text-2xl font-bold z-50 text-center overflow-hidden text-ellipsis p-4">
                                      {art.title_Bangla}
                                    </span>
                                  </div>
                                )}
                                <div className="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-500 ease-in-out">
                                  <h1 className="text-white text-3xl font-bold z-10 custom-font">
                                    View Writing
                                  </h1>
                                </div>
                              </div>
                          ...
                          switch (selectedCategory) {
                            case "Paintings":
                              totalItems = arts.filter(
                                (art) => art.type === "painting"
                              ).length;
                              break;
                            case "Drawings":
                              totalItems = arts.filter(
                                (art) => art.type === "drawing"
                              ).length;
                              break;
                            case "Sketches":
                              totalItems = arts.filter(
